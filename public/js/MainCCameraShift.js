...
function Main(){
    ...
    /*drawCanvas.style.left = 0 + 'px';
    drawCanvas.style.top = (document.getElementById('menubar').height) + 'px';*/
...
function onDrawMouseDown(event){
    ...
    */
    ...
    //on draw mouse add change camera location / focus
    /*
...
*/
  ...
  /*  texture = new THREE.ImageUtils.loadTexture( 'background.jpg');
    ...
    planeXYGeometry=new THREE.PlaneGeometry( 10000, height, 32, 32 );
